...
export default function UserDropdown({open, onClose, activeButton, setActiveButton}: UserDropdownProps) {
    ...
    return (
        ...
        >
            {/* User Info */}
            <Box sx={{padding: "16px"}}>
                <Typography variant="subtitle1" sx={{fontWeight: "medium", marginBottom: "4px"}}
