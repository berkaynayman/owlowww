    ...
    const navigationItems = [
        {
            ...
            items: [{name: t.items.dashboard, icon: <BookIcon/>, href: "/dashboard"}],
        },
        {
            category: t.categories.content,
            items: [{name: t.items.bookmarks, icon: <BookmarkIcon/>, href: "/dashboard/bookmarks"}],
        },
        {
            category: t.categories.hubs,
            items: [{name: t.items.playbook, icon: <PlaybookIcon/>, href: "/dashboard/essentials"}],
        },
        {
            category: t.categories.system,
            items: [{name: t.items.settings, icon: <SettingsIcon/>, href: "/dashboard/settings"}],
        },
    ]
    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Logo */}
                <Box sx={{
                    background: "rgb(var(--ow-brand-primary))",
                    padding: "20px",
                    display: "flex",
                    flexDirection: 'row',
                                        ...
                                        <ListItem key={itemIndex} disablePadding>
                                            <ListItemButton
                                                ...
                                                sx={{
                                                    ...
                                                    marginBottom: 1,
                                                    mx: 1,
                                                    color: isActive ? (isDarkMode ? "white" : "#000") : isDarkMode ? "#aaa" : "#757575",
                                                    backgroundColor: isActive ? (isDarkMode ? "rgb(17 24 39)" : "#F5F5F7") : "transparent",
                                                    "&:hover": {
                                                        backgroundColor: isDarkMode ? "rgb(17 24 39)" : "#F5F5F7",
                                                    ...
                                                    "&.Mui-selected": {
                                                        ...
                                                        color: isDarkMode ? "white" : "#000",
                                                        "&:hover": {
                                                            backgroundColor: isDarkMode ? "rgb(17 24 39)" : "#e5e5e7",
                                                        },
                                                    },
                                                    "& svg": {
                                                        color: "currentColor",
