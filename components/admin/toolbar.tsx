...
import { Badge, Box, IconButton, InputBase, Paper, Typography } from "@mui/material"
import {
...
import AdminNotificationsDropdown from "./notifications-dropdown"

interface AdminToolbarProps {
  onMenuClick?: () => void
}

export default function AdminToolbar({ onMenuClick }: AdminToolbarProps) {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: "flex", alignItems: "center" }}>
        <Typography
          variant="h6"
          sx={{ fontWeight: "500", color: "#333", marginLeft: isMobile ? 0 : 2 }}
      ...
      <AdminNotificationsDropdown open={notificationsOpen} onClose={() => setNotificationsOpen(false)} />
